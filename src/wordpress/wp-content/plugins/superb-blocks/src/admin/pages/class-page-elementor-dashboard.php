        ...
        <div id="superbaddons-elementor-is-active-wrapper">
            <?php new ContentBoxLarge(
                array(
                    ...
                    "description" => __("Unleash the full potential of Elementor with Superb Addons. Create pixel-perfect designs and take your website-building skills to the next level with our seamless integration that gives you access to 250 Elementor sections, elements. Unlock the potential to create visually stunning, high-converting websites in record time.", "superbaddons"),
                    "image" => "asset-medium-elementor.jpg",
                    "icon" => "logo-elementor.svg",
                    "class" => 'superbaddons-admindashboard-elementor-box'
                )
