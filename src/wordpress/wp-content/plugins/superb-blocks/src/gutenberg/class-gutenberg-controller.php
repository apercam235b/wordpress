...
class GutenbergController
{
    ...
    public static function GetGutenbergLibraryMenuItems()
    {
        return array(
            array(
                "id" => "patterns",
                "title" => esc_html__('Patterns', 'superbaddons'),
                "routes" => array(
                    "list" => LibraryRequestController::GUTENBERG_LIST_ROUTE,
                    "insert" => LibraryRequestController::GUTENBERG_INSERT_ROUTE
                ),
                "hidden" => false
            )
        );
    ...
    public function EnqueueBlockEditorAssets()
    {
        ...
        wp_localize_script('superb-addons-gutenberg-library', 'superblayoutlibrary_g', array(
            ...
            "snacks" => array(
                "insert_error" => esc_html__('Something went wrong while attempting to insert this element. Please try again or contact support if the problem persists.', 'superbaddons'),
        ...
        return array_merge(
            array(
                array(
                    ...
                    'title' => __('Superb Addons', 'superbaddons'),
                ),
            ),
            $block_categories
        );
