        ...
        <div class="superbaddons-admindashboard-modal-wrapper" style="display:none;">
            ...
            <div class="superbaddons-admindashboard-modal">
                ...
                <div class=" superbaddons-admindashboard-modal-footer">
                    <button type="button" class="superbaddons-element-button spbaddons-admin-btn-danger superbaddons-element-m0 superbaddons-admindashboard-modal-confirm-btn"><?= esc_html__("Confirm", "superbaddons"); ?></button>
                    <button type="button" class="superbaddons-element-button superbaddons-element-m0 superbaddons-admindashboard-modal-cancel-btn"><?= esc_html__("Cancel", "superbaddons"); ?></button>
                    <button type="button" class="superbaddons-element-button superbaddons-element-m0 superbaddons-admindashboard-modal-ok-btn"><?= esc_html__("OK", "superbaddons"); ?></button>
                </div>
            </div>
        </div>
